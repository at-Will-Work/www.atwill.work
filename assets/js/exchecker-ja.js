...
;(function($) {
  ...
  $.exValidationRules = $.extend($.exValidationRules, {
    ...
    chkretype: [
 	...
 	chkname: [ "ご氏名を入力してください", function(a, b) {
 	...
 	chksendername: [ "お申込者名を入力してください", function(a, b) {
		if ($(b).hasClass("chkgroup")) {
			var c = 0;
			$("input,select", b).each(function() {
				if ($(this).val().length > 0) c++;
 	...
 	chkcompany: [ "貴社名を入力してください", function(a, b) {
		if ($(b).hasClass("chkgroup")) {
			var c = 0;
			$("input,select", b).each(function() {
				if ($(this).val().length > 0) c++;
	...
	chkcity: [ "市区町村を入力してください", function(a, b) {
		if ($(b).hasClass("chkgroup")) {
			var c = 0;
			$("input,select", b).each(function() {
				if ($(this).val().length > 0) c++;
	...
	chkplace: [ "住所、ビル名等を入力してください", function(a, b) {
		if ($(b).hasClass("chkgroup")) {
			var c = 0;
			$("input,select", b).each(function() {
				if ($(this).val().length > 0) c++;
	...
	chkzipcode: [ "郵便番号を入力してください", function(a, b) {
		if ($(b).hasClass("chkgroup")) {
			var c = 0;
			$("input,select", b).each(function() {
				if ($(this).val().length > 0) c++;
	...
	chkmessage: [ "お問い合わせ内容を入力してください", function(a, b) {
		if ($(b).hasClass("chkgroup")) {
			var c = 0;
			$("input,select", b).each(function() {
				if ($(this).val().length > 0) c++;
	...
	chkreason: [ "入会理由を入力してください", function(a, b) {
		if ($(b).hasClass("chkgroup")) {
			var c = 0;
			$("input,select", b).each(function() {
				if ($(this).val().length > 0) c++;
